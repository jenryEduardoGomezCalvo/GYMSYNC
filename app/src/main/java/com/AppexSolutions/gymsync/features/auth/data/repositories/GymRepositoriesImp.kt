...
import com.AppexSolutions.gymsync.features.auth.data.datasource.remote.mapper.toRegisterRequest
...
class GymRepositoriesImp(
    ...
    override suspend fun RegisterUser(registerUser: RegisterUser): String {
        val response = gymApi.Register(registerUser.toRegisterRequest())
